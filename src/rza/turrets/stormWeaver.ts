 ...
 */
function findNextChainer(chainer: Entity): Entity | undefined {
 ...
 * @param stormWeaver - The storm weaver entity causing the damage.
 */
function visualizeLightningEffect(chainer: Entity, nextChainer: Entity, stormWeaver: Entity) {
 ...
 * @param stormWeaver - The storm weaver entity causing the damage.
 */
function scheduleChainerTagRemoval(stormWeaver: Entity) {
